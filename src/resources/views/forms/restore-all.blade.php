{!! html()->form('POST', route('laravelblocker::blocker-deleted-restore-all'))
    ...
    ->open() !!}
    @csrf
    {!! html()->button('<i class="fa fa-fw fa-history" aria-hidden="true"></i> ' . trans_choice('laravelblocker::laravelblocker.buttons.restore-all-blocked', 1, ['count' => $blocked->count()]), true)
        ->type('button')
